...
function fillAvailableWebassembly() {
  const availableWebassemblys = [
    ...
    "04B-howSum-tabulation",
    "05-bestSum",
    "05A-bestSum-memoization",
    "05B-bestSum-tabulation",
    "06-canConstruct",
    "06A-canConstruct-memoization",
    "06B-canConstruct-tabulation",
    "07-countConstruct",
    "07A-countConstruct-memoization",
    "07B-countConstruct-tabulation",
    "08-allConstruct",
    "08A-allConstruct-memoization",
    "08B-allConstruct-tabulation",
  ];
